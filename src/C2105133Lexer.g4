...
WHEN     : 'when' {writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <WHEN> Lexeme " + getText());};
...
QUES     : '?' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <QUES> Lexeme " + getText()); };
COLON    : ':' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <COLON> Lexeme " + getText()); };
ARROW    : '->' { writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <ARROW> Lexeme " + getText()); };
